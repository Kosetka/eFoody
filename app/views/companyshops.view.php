  ...
  <div id="layoutSidenav_content">
    <main class="form-signin container h-100 text-center" style="padding-top: 40px; max-width: 100%">
        ...
        <div class="card mb-4">
          ...
          <div class="card-body card-half">
            <div style="width: 30%;">
              ...
              <button id="generate-route" class="btn btn-primary" onclick="generateNewRoute()">Generuj trasę
                (Eksperymentalnie)</button>
      ...
      <script>
        ...
        const shops2 = <?php echo json_encode($data["companies"]); ?>; // Przekazanie danych o sklepach do JavaScript
        ...
        function displaySortedPoints(sortedWaypoints, waypoints, legs, arrivalTime) {
          ...
          sortedWaypoints.forEach((waypointIndex, index) => {
            ...
            const shop = findShopByLatLng2(latLng.lat(), latLng.lng());
            ...
            addNumberedMarker2(latLng, num_pos);
          });
        }

        function findShopByLatLng2(lat, lng) {
          return shops2.find(shop => shop.latitude == lat && shop.longitude == lng);
        }
        ...
        function addNumberedMarker2(position, number) {
    ...
    `;
        ...
        function txt_info(hour) {
          let txt_msg = document.getElementById("txt_msg");
          txt_msg.innerHTML = `Brak otwartego punktu o: <b>` + formatSecondsToCustomTime(hour) + `</b>. Szukam dalej...`;
        }
