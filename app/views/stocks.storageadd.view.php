...
?>
                <h1 class="h3 mb-3 fw-normal">Dodaj nowy zakup półproduktów</h1>
                <div class="text-start">
                    ...
                    <div class="form-group row m-3">
                        <label for="z_date" class="col-sm-2 col-form-label">Data zakupu:</label>
                        <div class="col-sm-3">
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function addProductToTable(product, quantity) {
        ...
        tr.innerHTML = `
            ...
            <td><input type="number" name="cost_${product.ID}" class="form-control" value="0" min="0" step="0.01" required></td>
