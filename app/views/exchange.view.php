...
<div id="layoutSidenav">
    ...
    <div id="layoutSidenav_content">
        <main class="form-signin container h-100 text-center" style="padding-top: 40px; max-width: 100%">
                                ...
                                <tbody>
                                    ...
                                    if(!empty($data["exchange_my"])){
                                        ...
                                        echo "  <tr><td>$photo</td>
                                            ...
                                            <td>".EXCHANGESTATUS[$value->result]."</td>
                ...
                <a href="<?php echo ROOT . '/exchange/new'?>" class="w-40 btn btn-lg btn-primary" style="margin-bottom: 40px;" type="submit">Dodaj nową ofertę przekazania</a>
                ...
                <script>
                                function clicked(id, user) {
                                    ...
                                    if(id == 4) lin = "cancel";
                                    $.ajax({
                                        url: '<?php echo ROOT . "/exchange/"?>'+ lin +'/' + id,
