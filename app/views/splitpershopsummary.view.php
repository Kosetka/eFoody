...
<div id="layoutSidenav">
    ...
    <div id="layoutSidenav_content">
        <main class="form-signin container h-100 text-center" style="padding-top: 40px; max-width: 100%">
            ...
            <div class="card mb-4">
                <div class="card-header">
                    <h2 class="">Produkty do zrobienia na dzień: <?php echo $date;?> <span style="color: green;">RANO</span></h2>
                    <div class="">
                        <div class="form-group row m-3">
                            <div class="col-sm-12">
            ...
            <div class="card mb-4">
                <div class="card-header">
                    <h2 class="">Produkty do zrobienia na dzień: <?php echo $date;?> <a href="#pdiv"><span style="color: red;">PO POŁUDNIU</span></a></h2>
                    <div class="">
                        <div class="form-group row m-3">
                            <div class="col-sm-12">
                                <table class="table table-bordered" id="orderedProductsTable">
            ...
            <div class="card mb-4" id="d<?php echo $driver->id;?>">
                <div class="card-header">
                    <h2 class="">Podział na sklepy dla: <?php echo $driver->first_name." ".$driver->last_name;?> <span style="color: green;">RANO</span></h2>
                    <div class="">
                        <div class="form-group row m-3">
                            <div class="col-sm-12">
                                <table class="table table-bordered" id="orderedProductsTable">
