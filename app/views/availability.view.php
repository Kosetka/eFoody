    ...
    <div id="layoutSidenav_content">
        <main class="form-signin container h-100 text-center" style="padding-top: 40px; max-width: 100%">
            <form method="post">
                ...
                <h1 class="h3 mb-3 fw-normal">Ustawienie stanów magazynowych</h1>
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Ustawione (Inw.)</th>
                                        <th scope="col">Zeskanowane</th>
                                        <th scope="col">Dodane do stanu</th>
                                        <th scope="col">Zdjęte ze stanu</th>
                                        <th scope="col">Pobrane (przez handlowca)</th>
                                        <th scope="col">Zwroty (od handlowca)</th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($data["product_quantity"] as $key => $value) {
                                        ...
                                        echo "  <tr><td>$photo</td>
                                            ...
                                            <td style='white-space: nowrap'>$product_sku</td>
                                            <td>$product_ean</td>
                                            <td>";
                                        echo '<input type="number" class="form-check-input p-2" style="width: 80px; height: 30px" id="p_id" name="p_id[' . $key . ']" value="' . $amount_left . '">';
